...
```{r scf-dist, out.width="50%", fig.align = "center", warning=FALSE, fig.width=6, fig.height=4}
...
```{r tree-comps-gt, out.width="50%", fig.align = "center", warning=FALSE, fig.width=12, fig.height=16}
...
# Select an M1 locus as an example. Other good ones are: chr15-72
...
If you have the knitr package installed you can compile this document to an HTML page and save it with all figures generated. To do so, click on the "Knit" button above the text editor!
