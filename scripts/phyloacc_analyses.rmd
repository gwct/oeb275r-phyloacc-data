...
Where $Y$ is the data (aligned sequences) and $M*$ is the model. As you can see, this is BF1 and is calculated in the main output table. We can also compare the model that allows accelerated rates to be fit to only the target lineages (M1) to a model that allows accelerated rates on any lineage (M2):
...
## Ancestral marine mammal accelerations
